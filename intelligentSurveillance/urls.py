...
urlpatterns = [
    ...
    path("sfReportComment", views.sfReportComment),
    path("sfReportPost", views.sfReportPost),
    ...
    path("adminViewChatDetections", views.adminViewChatDetections),
    path("adminViewCommentDetections", views.adminViewCommentDetections),
    path("adminViewReportedComment", views.adminViewReportedComment),
    path("adminDeleteReportedComment", views.adminDeleteReportedComment),
    path("adminIgnoreReportedComment", views.adminIgnoreReportedComment),
    path("adminViewReportedPost", views.adminViewReportedPost),
    path("adminIgnoreReportedPost", views.adminIgnoreReportedPost),
    path("adminDeleteReportedPost", views.adminDeleteReportedPost),
]
